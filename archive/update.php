    ...
    <body>
        ...
        <div class="actionBar">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <input type="text" name="title" id="title" placeholder="Title" maxlength="40" pattern=".[a-zA-Z\W\s]{2,}" value="'.$key['title']. '">
                <label for="author">Author</label>
                <input type="text" name="author" id="author" placeholder="Author" maxlength="40" pattern=".[a-zA-Z\W\s]{2,}" value="'.$key['author']. '">
                <label for="published">First Published Year</label><br>
                <input type="text" name="published" id="published" placeholder="YYYY" pattern="[0-9]{4}" value="'.$key['published']. '"><br>
                <label for="copies">Copies</label><br>
                <input type="text" name="copies" id="copies" placeholder="Number Of Copies" pattern="[0-9]{1,}" value="'.$key['copies']. '"><br>
                <label for="bookRanking">Book Ranking</label><br>
                <input type="text" name="bookRanking" id="bookRanking" placeholder="Book Ranking" step="any" pattern="^([-+,0-9.]+)" value="'.filter_var($key['ranking'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION). '"><br>
                <label for="bookPlot">Book Plot</label><br>
                <textarea type="text" name="bookPlot" id="bookPlot" placeholder="Book Plot" pattern=".[a-zA-Z\W\s]{2,}">'.$key['bookPlot'].'</textarea><br>
